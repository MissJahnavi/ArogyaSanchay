          ...
          records.map((r) => (
            <div key={r._id} className="bg-white rounded-lg shadow p-4 flex flex-col justify-between">
              ...
              <div className="flex flex-wrap gap-2 mt-4">
                ...
                {r.fileUrl && (
                  <a href={`http://localhost:3000${r.fileUrl}`} target="_blank" rel="noopener noreferrer" className="px-2 py-1 bg-blue-100 text-blue-700 rounded hover:bg-blue-200 text-sm">Download (Original)</a>
                )}
